...
function rerun3(myexp)
	...
	msg="update parameter file : "*split(fil,"/")[end]
	log(myexp,msg,fil=fil)
	...
	log(myexp,"output file from run3",fil=fil)
...
function rerun2(myexp)
	...
	cp(joinpath(run_path,"output.txt"),fil)
	log(myexp,"output file from run2",fil=fil)
...
function rerun1(myexp)
	...
	write(fil,nml)
	fil="update parameter file : "*split(fil,"/")[end]
	log(myexp,msg,fil=fil)
	...
	cp(joinpath(run_path,"output.txt"),fil)
	log(myexp,"output file from run1",fil=fil)
...
git-tree-sha1 = "871326004d577f364b18961970126f47928830ee"
